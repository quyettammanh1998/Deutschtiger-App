...
void main() async {
  ...
  final mappings = <(RegExp, String)>[
    ...
    (
      RegExp(
        r"import\s+'package:deutschtiger/core/auth/disabled_auth_service\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:deutschtiger/core/notifications/([^']+)\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/features/ai/domain/ai_models\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/features/(\w+)/domain/([^']+)\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/features/(\w+)/data/([^']+)\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/core/identity/profile_repository\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/features/(\w+)/presentation/([^']+)\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/features/(\w+)/widgets/([^']+)\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/core/theme/theme_provider\.dart'",
      ),
    ...
    (
      RegExp(
        r"import\s+'package:Deutschtiger/core/preferences/preferences_provider\.dart'",
      ),
