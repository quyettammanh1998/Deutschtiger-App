                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        _showHints ? 'Hide Sample Answer' : 'Show Sample Answer',
                      ),
                    ),
                    if (_showHints) ...[
                      const SizedBox(height: 16),
...
final List<_SpeakingTopicData> _teilATopics = [
  const _SpeakingTopicData(
    number: 1,
    title: 'Vorstellen',
    prompt: 'Lesen Sie die following Aussage vor:\n\n„In der modernen Arbeitswelt ist es wichtig, flexible Arbeitszeiten zu haben. Viele Unternehmen bieten Homeoffice an, um die Work-Life-Balance zu verbessern."',
    durationMinutes: 3,
    sampleAnswer: 'In der modernen Arbeitswelt ist es wichtig, flexible Arbeitszeiten zu haben. Viele Unternehmen bieten Homeoffice an, um die Work-Life-Balance zu verbessern.',
    keyVocab: 'Arbeitswelt, flexible Arbeitszeiten, Homeoffice, Work-Life-Balance, verbessern',
  ...
  const _SpeakingTopicData(
    number: 2,
    title: 'Umwelt',
    prompt: 'Lesen Sie die folgende Aussage vor:\n\n„Umweltbewusstsein ist heute wichtiger denn je. Wir müssen unseren CO2-Ausstoß reduzieren und mehr recyceln, um die Umwelt zu schützen."',
    durationMinutes: 3,
    sampleAnswer: 'Umweltbewusstsein ist heute wichtiger denn je. Wir müssen unseren CO2-Ausstoß reduzieren und mehr recyceln, um die Umwelt zu schützen.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Eine ausgewogene Ernährung und regelmäßige Bewegung sind die Grundlage für ein gesundes Leben. Sport hilft nicht nur körperlich, sondern auch mental.',
    keyVocab: 'ausgewogene Ernährung, regelmäßige Bewegung, gesundes Leben, mental',
    structure: 'Betonen Sie die wichtigen Wörter: Ernährung, Bewegung, gesund, Sport.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Bildung ist der Schlüssel zum Erfolg. In der heutigen Zeit ist lebenslanges Lernen besonders wichtig, um mit der schnellen Entwicklung Schritt zu halten.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Digitale Technologien verändern unseren Alltag grundlegend. Smartphones und das Internet sind aus unserem Leben nicht mehr wegzudenken.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Reisen erweitert den Horizont und hilft uns, andere Kulturen besser zu verstehen. Urlaub ist wichtig für unsere Erholung und Kreativität.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Freizeitaktivitäten sind wichtig für unser Wohlbefinden. Ob Sport, Lesen oder Musik – jeder sollte Zeit für seine Hobbys haben.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Die Familie ist der wichtigste Rückhalt im Leben. In schwierigen Zeiten können wir uns immer auf unsere Familie verlassen.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Gute Kommunikation ist die Basis für erfolgreiche Beziehungen. Zuhören ist genauso wichtig wie Sprechen.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: 'Die Zukunft gehört denen, die an die Schönheit ihrer Träume glauben. Mit Fleiß und Ausdauer können wir unsere Ziele erreichen.',
...
final List<_SpeakingTopicData> _teilBTopics = [
  const _SpeakingTopicData(
    ...
    prompt: 'Sprechen Sie über das Thema „Urlaub planen":\n• Wo möchten Sie hingehen?\n• Was möchten Sie dort machen?\n• Wie planen Sie die Reise?',
    durationMinutes: 4,
    sampleAnswer: 'Ich möchte gerne nach Spanien in den Urlaub fahren. Ich interessiere mich für die spanische Kultur und das gute Wetter. Ich möchte Barcelona besuchen und die Strände genießen. Für die Reise plane ich, eine Woche dort zu bleiben und in einem Hotel in der Nähe des Strandes zu wohnen.',
    keyVocab: 'Urlaub, buchen, Reise, Hotel, Strand, Kultur, Sehenswürdigkeiten',
  ...
  const _SpeakingTopicData(
    ...
    prompt: 'Sprechen Sie über das Thema „Gesunde Ernährung":\n• Was essen Sie gesund?\n• Kochen Sie selbst?\n• Was ist wichtig bei der Ernährung?',
    durationMinutes: 4,
    sampleAnswer: 'Ich versuche, gesund zu essen. Ich esse viel Obst und Gemüse und trinke genug Wasser. Ja, ich koche meistens selbst, weil es gesünder und günstiger ist. Bei der Ernährung ist es wichtig, abwechslungsreich zu essen und nicht zu viel Zucker zu konsumieren.',
  ...
  const _SpeakingTopicData(
    number: 3,
    title: 'Sport treiben',
    prompt: 'Sprechen Sie über das Thema „Sport treiben":\n• Treiben Sie Sport?\n• Welchen Sport machen Sie?\n• Warum ist Sport wichtig?',
    durationMinutes: 4,
    sampleAnswer: 'Ja, ich treibe regelmäßig Sport. Ich gehe zweimal pro Woche ins Fitnessstudio und schwimme am Wochenende. Sport ist wichtig, weil er gesund ist und Stress abbaut. Außerdem fühle ich mich danach besser und habe mehr Energie.',
    keyVocab: 'Sport treiben, Fitnessstudio, schwimmen, Stress abbauen, Energie',
  ...
  const _SpeakingTopicData(
    number: 4,
    title: 'Berufswahl',
    prompt: 'Sprechen Sie über das Thema „Berufswahl":\n• Was möchten Sie beruflich machen?\n• Warum haben Sie sich dafür entschieden?\n• Was ist wichtig bei der Berufswahl?',
    durationMinutes: 4,
    sampleAnswer: 'Ich möchte gerne im Bereich Marketing arbeiten. Ich habe mich dafür entschieden, weil ich kreativ bin und gerne mit Menschen arbeite. Bei der Berufswahl ist es wichtig, dass man Spaß an der Arbeit hat und die Möglichkeit hat, sich weiterzuentwickeln.',
  ...
  const _SpeakingTopicData(
    number: 5,
    title: 'Wohnen',
    prompt: 'Sprechen Sie über das Thema „Wohnen":\n• Wo wohnen Sie?\n• Wie ist Ihre Wohnung?\n• Was ist wichtig beim Wohnen?',
    durationMinutes: 4,
    sampleAnswer: 'Ich wohne in einer kleinen Wohnung in der Stadt. Die Wohnung hat zwei Zimmer, eine Küche und ein Bad. Mir ist wichtig, dass sie hell ist und in der Nähe meiner Arbeit liegt. Außerdem sollte sie nicht zu teuer sein.',
  ...
  const _SpeakingTopicData(
    number: 6,
    title: 'Freunde',
    prompt: 'Sprechen Sie über das Thema „Freunde":\n• Was macht gute Freunde aus?\n• Wie haben Sie Ihre besten Freunde kennengelernt?\n• Wie oft treffen Sie Ihre Freunde?',
    durationMinutes: 4,
    sampleAnswer: 'Gute Freunde sind ehrlich und zuverlässig. Man kann mit ihnen über alles sprechen. Meine besten Freunde habe ich in der Schule und im Deutschkurs kennengelernt. Wir treffen uns ungefähr einmal pro Woche.',
  ...
  const _SpeakingTopicData(
    number: 7,
    title: 'Lernen',
    prompt: 'Sprechen Sie über das Thema „Lernen":\n• Wie lernen Sie am besten?\n• Lernen Sie lieber allein oder in der Gruppe?\n• Welche Tipps haben Sie zum Lernen?',
    durationMinutes: 4,
    sampleAnswer: 'Ich lerne am besten, wenn ich mir Notizen mache und sie wiederhole. Ich lerne lieber allein, weil ich mich besser konzentrieren kann. Mein Tipp ist: Regelmäßig lernen, nicht alles auf einmal.',
  ...
  const _SpeakingTopicData(
    number: 8,
    title: 'Umwelt',
    prompt: 'Sprechen Sie über das Thema „Umweltschutz":\n• Was tun Sie für die Umwelt?\n• Ist Umweltschutz wichtig?\n• Was können wir noch tun?',
    durationMinutes: 4,
    sampleAnswer: 'Ich versuche, weniger Plastik zu verwenden und recycle so viel wie möglich. Ja, Umweltschutz ist sehr wichtig, weil wir nur einen Planeten haben. Wir können mehr Rad fahren, weniger Fleisch essen und energiesparende Geräte benutzen.',
  ...
  const _SpeakingTopicData(
    number: 9,
    title: 'Medien',
    prompt: 'Sprechen Sie über das Thema „Medien":\n• Welche Medien nutzen Sie?\n• Wie viel Zeit verbringen Sie damit?\n• Was sind die Vor- und Nachteile?',
    durationMinutes: 4,
    sampleAnswer: 'Ich nutze hauptsächlich mein Smartphone und den Computer. Ich verbringe etwa zwei Stunden pro Tag damit. Die Vorteile sind, dass man schnell Informationen bekommt und mit Freunden in Kontakt bleibt. Die Nachteile sind, dass man weniger Zeit für andere Aktivitäten hat.',
    keyVocab: 'Medien, Smartphone, Computer, Informationen, Kontakt, Vorteile, Nachteile',
  ...
  const _SpeakingTopicData(
    ...
    prompt: 'Sprechen Sie über das Thema „Sprachen lernen":\n• Welche Sprachen sprechen Sie?\n• Wie lernen Sie Sprachen?\n• Warum ist es wichtig, Sprachen zu lernen?',
    durationMinutes: 4,
    sampleAnswer: 'Ich spreche Deutsch, Englisch und ein bisschen Spanisch. Ich lerne Sprachen, indem ich Bücher lese und Podcasts höre. Außerdem spreche ich so oft wie möglich mit Muttersprachlern. Sprachen zu lernen ist wichtig, weil es berufliche Chancen verbessert und man andere Kulturen besser versteht.',
...
final List<_SpeakingTopicData> _teilCTopics = [
  const _SpeakingTopicData(
    number: 1,
    title: 'Arzttermin',
    prompt: 'Hinterlassen Sie eine Nachricht auf dem Anrufbeantworter:\n• Sie möchten einen Termin beim Arzt vereinbaren\n• Sie haben Schmerzen im Rücken\n• Sie können nächste Woche vormittags',
    durationMinutes: 3,
    sampleAnswer: 'Guten Tag, hier spricht Thomas Müller. Ich möchte gerne einen Termin bei Ihnen vereinbaren. Ich habe seit einigen Tagen Schmerzen im Rücken. Nächste Woche wäre mir gut, am liebsten vormittags. Bitte rufen Sie mich zurück unter der Nummer 0123 456789. Vielen Dank und auf Wiederhören.',
  ...
  const _SpeakingTopicData(
    ...
    durationMinutes: 3,
    sampleAnswer: '